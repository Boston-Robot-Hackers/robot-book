...
The official documentation for ROS 2 Humble is at [docs.ros.org/en/jazzy](https://docs.ros.org/en/jazzy/). When any concept in this chapter needs more depth — DDS transport, QoS settings, lifecycle nodes — that is the authoritative reference.
